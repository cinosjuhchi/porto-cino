...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_klrnh5e', 'template_nb3vps9', form.current, 'yo-F8pnPa-jvhmlAq').then(
      (result) => {
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Jeorsge Peterson</span>
              <a href="https://facebook.com/pacino.353" className="contact__button">
                Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
              spam
            </div>
